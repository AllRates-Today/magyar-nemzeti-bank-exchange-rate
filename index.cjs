'use strict';
// Magyar Nemzeti Bank exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/mnb';
...
/** Latest rate for one pair, e.g. getRate('EUR', 'HUF', { apiKey }). */
